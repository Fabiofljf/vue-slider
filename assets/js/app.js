...
const app = new Vue({
    ...
    data: {
        ...
        images: [
            ...
            { image: 'img/05.jpg', title: 'Paradise', text: 'Et temporibus voluptatum suscipit tempore aliquid deleniti aut veniam inventore eligendi ex ad ullam, cumque provident totam omnis.' }
        ],
    },
    methods: {
        next() {
